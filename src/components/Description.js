    ...
    <>
      ...
      <div id="services">
        <div id="rectangle1" className="service">
          ...
          <p>Access and Order from an extensive catalogue in any language and on 
        ...
        <div id="rectangle2" className="service">
          ...
          <p>Add your preferences and brand assets to ensure the contents is consistent 
        ...
        <div id="rectangle3" className="service">
          ...
          <p>Your details are translated and sent to the AI, FP, or both (per your choice) as 
        ...
        <div id="rectangle4" className="service">
          ...
          <p>The finished content is delivered and you can make corrections that we will effect
